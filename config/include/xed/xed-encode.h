...
// establish a type equivalence for xed_encoder_request_t and
// corresponding xed_decoded_inst_t.
typedef xed_decoded_inst_t xed_encoder_request_t;

// Encoder variables structure
struct xed_encoder_vars_s {
    xed_uint8_t* operand_order;
    xed_uint8_t n_operand_order;
};
...
/// @ingroup ENC
static XED_INLINE const xed_operand_values_t*
xed_encoder_request_operands(const xed_encoder_request_t* p) {
    return p;
}
